...
## Phase I - For this first phase, aim to write out the pieces that will need to be programmed to create the functionality of your application. Try to break it into 6-7 pieces (12 Minutes)
...
## Phase II - For this second phase, aim to complete the following (15 Minutes)
...
## Phase III - For this third phase, aim to complete the following (30 Minutes)
...
## Phase IV - For this fourth phase, aim to complete the following (45 Minutes)
...
## Phase V - For the fifth and final phase, aim to complete the following (15 Minutes)
